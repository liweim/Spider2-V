...
def run_human_agent():
    ...
    parser.add_argument('-e', '--example', type=str, default="evaluation_examples/select_human.json", help='.json file path to examples')
    ...
    ids = df[df['check']==-1][['domain', 'id']].values
